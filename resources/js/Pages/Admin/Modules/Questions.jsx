...
export default function Questions() {
  ...
  return (
    <AdminLayout title="Modules - Question Bank">
                ...
                <div
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2">
                      <span className="material-icons text-gray-300 cursor-pointer hover:text-blue-500">
                        edit
                      </span>
                      <span className="material-icons text-gray-300 cursor-pointer hover:text-red-500">
                        delete
                      </span>
                    </div>
                  </div>
