...
import {
  Clock, CheckCircle, XCircle, Plus, StopCircle, ArrowLeft, RefreshCw, Lock, AlertCircle
} from "lucide-react";
                    ...
                    return (
                        <div key={q.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition">
                            ...
                            <div className="flex gap-4 mb-4">
                                ...
                                {/* 🔥 Layout Vertikal agar Badge tidak Nimpah */}
